...
<div class="container clearfix">
    ...
    <div class="main-wrap">
        ...
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="/boke/index.php/Admin/Index/index">首页</a><span class="crumb-step">&gt;</span><span class="crumb-name">关注管理</span></div>
        </div>
        <div class="search-wrap">
         ...
         <div class="result-wrap">
            <form name="myform" id="myform"  action="/boke/index.php/Admin/Admin/sort" method="post">
                <div class="result-title">
                    <div class="result-list">
                        <a href="/boke/index.php/Admin/Admin/add"><i class="icon-font"></i>添加关注</a>
                ...
                <div class="result-content">
                    <table class="result-tab" width="100%">
                        ...
                        <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                            ...
                            <td title="{vo.username}"><?php echo ($vo["username"]); ?>
                            </td>
                            <td>
                                <a class="link-update" href="/boke/index.php/Admin/Admin/edit/id/<?php echo ($vo["id"]); ?>">修改</a>
                                <a class="link-del"  onclick="return confirm('确认删除？');"  href="/boke/index.php/Admin/Admin/del/id/<?php echo ($vo["id"]); ?>">删除</a>
                            </td>
