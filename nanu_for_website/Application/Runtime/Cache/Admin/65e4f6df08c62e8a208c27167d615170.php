    ...
    <div class="main-wrap">
        ...
        <div class="search-wrap">
         ...
         <div class="result-wrap">
            <form name="myform" id="myform"  action="/boke/index.php/Admin/Link/sort" method="post">
                <div class="result-title">
                    <div class="result-list">
                        <a href="/boke/index.php/Admin/Link/add"><i class="icon-font"></i>新增链接</a>
                ...
                <div class="result-content">
                    <table class="result-tab" width="100%">
                        ...
                        <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                            ...
                            <td title="{vo.url}"><a target="_blank" href="<?php echo ($vo["url"]); ?>" title="<?php echo ($vo["url"]); ?>"><?php echo ($vo["url"]); ?></a> …
                            </td>
                            <td title="{vo.desc}"><?php echo ($vo["desc"]); ?></a> …
                            </td>
                            <td>
                                <a class="link-update" href="/boke/index.php/Admin/Link/edit/id/<?php echo ($vo["id"]); ?>">修改</a>
                                <a class="link-del"  onclick="return confirm('确认删除？');"  href="/boke/index.php/Admin/Link/del/id/<?php echo ($vo["id"]); ?>">删除</a>
                            </td>
